...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Seleccionar candidato de toda la Base de Dato</h1>
    </div>               
</div>
<div>
    <table class="table table-hover table-striped table-bordered candidatos" >
         <thead>
            ...
            <tbody>
            <?php $user = User::where('role_id', 3)->get(); ?>
                @foreach($user as $value)
                    ...
                    @endif
                        ...
                        <td><a href="{{ URL::to('administrador/Perfil/'. $value->username .'/vacante/'. $vacante->id . '' ) }}" target="new">{{ $value->usuariodato->nombres }}</a> </td>
