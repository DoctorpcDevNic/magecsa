...
<div class="reclutamiento evaluacion">
	...
	<div class="etapas">
		<div class="row">
			<div class="etapa col-md-6" style=" height: 290px">
				<div class="triangulo computer"></div>
				<h3 class="tituletapa wow bounceInRight">Etapa1: Evaluación de Profesionales</h3>
				<div class="col-md-12"><img src="{{ asset('img/deficinion.png') }}" alt="">Deﬁnición de Evaluaciones a aplicar según Perﬁl y nivel del Puesto</div>
				<div class="col-md-12"><img src="{{ asset('img/envioonline.png') }}" alt="">Envío de Evaluaciones Online a Candidato</div>
				<div class="col-md-12"><img src="{{ asset('img/confirmacion.png') }}" alt="">Se conﬁrma con el candidato si recibió las Evaluaciones</div>
			</div>
			<div class="etapa col-md-6">
				<div class="triangulo computer"></div>
				<h3 class="tituletapa wow bounceInLeft">Etapa2: Resultados de Evaluaciones</h3>
				<div class="col-md-12"><img src="{{ asset('img/seleccv.png') }}" alt="">Revisión de Resultados</div>
				<div class="col-md-12"><img src="{{ asset('img/presentacionreporte.png') }}" alt="">Presentación de Reportes Individuales de cada test psicométrico aplicado.</div>
				<div class="col-md-12"><img src="{{ asset('img/prestresumen.png') }}" alt="">Presentación de Resumen Ejecutivo de la adecuación de la persona al puesto</div>
			</div>
		</div>	
	</div>
